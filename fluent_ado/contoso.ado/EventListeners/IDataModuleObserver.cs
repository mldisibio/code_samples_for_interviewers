...
namespace contoso.ado.EventListeners
{
    ...
    /// </summary>
    public interface IDataModuleObserver
    {
        ...
        void ConnectionFailed(string? connDesc, Exception exception);
        ...
        void CommandFailed(string? commandText, Exception exception);
        ...
        /// <param name="format">The event description or message format string.</param>
        /// <param name="args">An object array containing zero or more objects to format.</param>
        void TraceError(Exception? exception, string? format = null, params object[] args);
    }
}
