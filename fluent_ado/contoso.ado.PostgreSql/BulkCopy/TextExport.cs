...
namespace contoso.ado.PostgreSql
{
    ...
    public class TextExport<TOut>
    {
        readonly PostgresCommandContext _ctx;
        readonly Func<TextReader, TOut> _readData;

        internal TextExport(PostgresCommandContext cmdCtx, Func<TextReader, TOut> readData) { _ctx = cmdCtx; _readData = readData; }
