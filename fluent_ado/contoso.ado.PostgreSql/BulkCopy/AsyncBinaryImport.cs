...
namespace contoso.ado.PostgreSql
{
    ...
    public class AsyncBinaryImport<TIn>
    {
        readonly PostgresCommandContext _ctx;
        readonly Func<TIn, NpgsqlBinaryImporter, Task> _writeDataAsync;

        internal AsyncBinaryImport(PostgresCommandContext cmdCtx, Func<TIn, NpgsqlBinaryImporter, Task> writeDataAsync) { _ctx = cmdCtx; _writeDataAsync = writeDataAsync; }
