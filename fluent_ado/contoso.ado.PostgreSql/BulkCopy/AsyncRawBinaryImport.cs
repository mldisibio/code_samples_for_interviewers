...
namespace contoso.ado.PostgreSql
{
    ...
    public class AsyncRawBinaryImport<TIn>
    {
        readonly PostgresCommandContext _ctx;
        readonly Func<TIn, Stream, Task> _writeDataAsync;

        internal AsyncRawBinaryImport(PostgresCommandContext cmdCtx, Func<TIn, Stream, Task> writeDataAsync) { _ctx = cmdCtx; _writeDataAsync = writeDataAsync; }
