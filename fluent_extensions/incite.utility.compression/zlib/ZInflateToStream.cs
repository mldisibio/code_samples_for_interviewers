...
/// <summary>Common for all synchronous implementations inflating a zlib file or stream to an output stream.</summary>
public abstract class ZInflateToStream
{
    /// <summary>Base ctor.</summary>
    protected ZInflateToStream()
    {
