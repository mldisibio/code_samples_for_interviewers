...
/// <summary>Common for all asynchronous implementations inflating a zlib file or stream to an output stream.</summary>
public abstract class ZInflateAsyncToStream
{
    /// <summary>Base ctor.</summary>
    protected ZInflateAsyncToStream()
    {
    ...
    /// True if the stream is inflated without error and the output stream is accessible and has content.
