...
/// <example>
///     <code>
///         var reader = ZLibReader.CreateFor(zlibStream).AndExtractToFile('path_to_output_file');
///     </code>
/// </example>
internal sealed class ZLibStreamToFile : ZInflateToFile
{
    readonly StreamToFile _io;

    internal ZLibStreamToFile(in StreamToFile ioPair)
        : base()
    {
        _io = ioPair;
