...
/// <summary>Common for all asynchronous implementations inflating a zlib file or stream to an output file.</summary>
public abstract class ZInflateAsyncToFile
{
    /// <summary>Base ctor.</summary>
    protected ZInflateAsyncToFile()
    {
    ...
    /// <summary>
    /// Asynchronously decompress the configured source to the configured output file
    ...
    /// Otherwise false. Failure reason and/or exception will be found in <see cref="DecompressToStreamResult.Error"/>.
    /// </returns>
    public abstract Task<DecompressToFileResult> DecompressAsyncWithoutCRC();

    /// <summary>
    /// Attempt to asynchronously decompress the source using the zlib library, and if the operation fails,
    ...
    /// Otherwise false. Failure reason and/or exception will be found in <see cref="DecompressToStreamResult.Error"/>.
    /// </returns>
    public abstract Task<DecompressToFileResult> DecompressAsyncWithRetry();
