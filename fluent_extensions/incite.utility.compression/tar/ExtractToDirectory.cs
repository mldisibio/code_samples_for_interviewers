...
/// <summary>Common for all synchronous implementations extracting a tar archive to an output directory.</summary>
public abstract class ExtractToDirectory
{
    /// <summary>Base ctor.</summary>
    protected ExtractToDirectory()
    {
    ...
    /// <summary>Extract a tar archive into the configured output directory.</summary>
    /// <returns>
    ...
    /// </returns>
    public abstract ExtractToDirectoryResult Extract();
