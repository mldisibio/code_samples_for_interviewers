...
internal sealed class AsyncTarGzStreamToDirectory : UnzipAndExtractAsyncToDirectory
{
    readonly StreamToDirectory _io;

    internal AsyncTarGzStreamToDirectory(in StreamToDirectory ioPair)
        : base()
    {
        _io = ioPair;
    ...
    public override async Task<ExtractToDirectoryResult> UnzipAndExtractAsync()
    {
        ...
        try
        {
            ...
            {
                DecompressToStreamResult unzipResult = await GZipReader.CreateFor(_io.Input.Stream)
