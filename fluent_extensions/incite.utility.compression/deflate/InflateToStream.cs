...
/// <summary>Common for all synchronous implementations decompressing a raw deflate stream to an output stream.</summary>
public abstract class InflateToStream
{
    /// <summary>Base ctor.</summary>
    protected InflateToStream()
    {
