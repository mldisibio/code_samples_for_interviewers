...
/// <summary>Common for all synchronous implementations decompressing a raw deflate stream to an output file.</summary>
public abstract class InflateToFile
{
    /// <summary>Base ctor.</summary>
    protected InflateToFile()
    {
