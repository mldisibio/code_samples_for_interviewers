...
/// <summary>Common for all synchronous implementations decompressing a zipped file or stream to an output file.</summary>
public abstract class UnzipToFile
{
    /// <summary>Base ctor.</summary>
    protected UnzipToFile()
    {
