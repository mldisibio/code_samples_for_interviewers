...
/// <summary>Common for all asynchronous implementations decompressing a zipped file or stream to an output file.</summary>
public abstract class UnzipAsyncToFile
{
    /// <summary>Base ctor.</summary>
    protected UnzipAsyncToFile()
    {
    ...
    /// True if the source is unzipped without error and the output file exists on disk. A zero length output returns false because it will be removed.
